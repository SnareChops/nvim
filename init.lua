...
require('lazy').setup({
  ...
  },
  {
    ...
    keys = {
      ...
      { '<leader>as', '<cmd>ClaudeCodeTreeAdd<cr>', desc = 'Add file', ft = { 'NvimTree', 'neotree', 'oil', 'minifiles', 'netrw' } },
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Broadcast cmp capabilities to all servers, then configure and enable each one.
